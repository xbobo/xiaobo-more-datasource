...
//	             + \"</if>\"
		...
		saveBatchbuffer.append("		  +  \" INSERT INTO message (name,content) VALUES  \" "+ lineFeed);
	    ...
	    saveBatchbuffer.append("	+\"</script>\" "+ lineFeed);
		saveBatchbuffer.append("	})"+ lineFeed);
		saveBatchbuffer.append("	@Options(useGeneratedKeys = true,keyColumn = \"id\",keyProperty = \"id\")"+ lineFeed);
...
//	             + \"</if>\"
		...
		removeBatchbuffer.append("		+ \"DELETE FROM message WHERE id in \""+ lineFeed);
