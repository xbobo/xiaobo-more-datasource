package org.xiaobo.websocket.conf;
...
@EnableSwagger2
@Profile({"dev","test"})
@ComponentScan(basePackages ={"org.xiaobo.**.controller"})
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("org.xiaobo.websocket.controller"))
